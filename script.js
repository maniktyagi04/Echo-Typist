...
const words = ['hello', 'world', 'javascript', 'developer', 'game', 'speed', 'keyboard', 'audio', 'challenge', 'typing', 'Lomesh', 'Manik', 'echo', 'krushna', 'opportunity', 'function', 'variable', 'technology', 'future'];
let currentWord = '';
let score = 0;
let timeLeft = 30;
let gameInterval;
